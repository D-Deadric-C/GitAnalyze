...
export function ChatInput({
    ...
    return (
        <div className="relative group/input max-w-4xl mx-auto">
            ...
            <div className="relative flex items-end bg-white backdrop-blur-xl border-2 border-gray-200 rounded-2xl p-2 focus-within:ring-2 focus-within:ring-amber-400/50 transition-all shadow-lg">
                <textarea
                    ref={textareaRef}
                    value={value}
                    ...
                    rows={1}
                    className={cn(
                        "block w-full bg-transparent border-none px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 transition-all resize-none min-h-[52px] max-h-[200px]",
                ...
                <div className="flex items-center gap-1.5 pb-1 pr-2" ref={dropdownRef}>
                    <div className="relative">
                        <button
                            ...
                            className={cn(
                                ...
                                modelPreference === "flash"
                                    ? "bg-[#FEF9F2] border-gray-200 text-gray-700 hover:bg-[#F9C79A] hover:text-gray-900"
                        ...
                        <AnimatePresence>
                            {showModelDropdown && (
                                <motion.div
                                    ...
                                    className="absolute bottom-full right-0 mb-4 w-52 bg-white backdrop-blur-2xl border-2 border-gray-200 rounded-2xl shadow-xl overflow-hidden z-50 p-1.5 flex flex-col gap-1"
                                >
                                    <button
                                        type="button"
                                        onClick={() => {
                                        ...
                                        className={cn(
                                            ...
                                            modelPreference === "flash" ? "bg-[#F9C79A] text-gray-900" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                                        )}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs transition-colors",
                                            modelPreference === "thinking" ? "bg-amber-100 text-gray-900" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                                        )}
                                    >
                    ...
                    >
                        <div className={cn(
                            ...
                            !disabled && value.trim() ? "bg-[#F9C79A] text-gray-900 border-2 border-gray-800 hover:scale-105 active:scale-95 shadow-md" : "bg-gray-200 text-gray-400 opacity-50 shadow-none border-2 border-gray-200"
                        )}>
